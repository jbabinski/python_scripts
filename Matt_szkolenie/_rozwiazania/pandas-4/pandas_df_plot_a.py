...
#     4. Wybierz pożądaną datę i lokację, następnie próbkuj co godzinę
#     5. Aktywność jest gdy `Luminance` jest różna od zera
#     6. Wyświetl wykres (line) z godzinami aktywności w dla lokacji
...
ax = result.plot(color='red', figsize=(10,10), yticks=[0,1])
ax.set_yticklabels(['seep', 'awake'])
